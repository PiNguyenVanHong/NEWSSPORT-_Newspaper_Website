...
const LoginModal = () => {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md lg:max-w-5xl bg-white text-black p-0 overflow-hidden">
        <DialogHeader>
          <DialogTitle></DialogTitle>
        </DialogHeader>
        <Card className="bg-transparent border-none shadow-none">
          <CardContent className="p-0 grid grid-cols-2 gap-4 items-stretch justify-end">
            <div className="col-span-1 p-1 -mt-4">
              <div className="w-full h-full rounded-lg overflow-hidden">
                <img src={Image} alt="" />
              </div>
            </div>
            <div className="col-span-1 my-10 flex flex-col items-center justify-center gap-8 px-6">
